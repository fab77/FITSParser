...
export declare class ParseUtils {
    ...
    static parseFloatingPointFormat(bytes: Uint8Array, ebits: number, fbits: number): number | undefined;
    ...
    static extractPixelValue(offset: number, bytes: Uint8Array, bitpix: number): number | undefined;
}
