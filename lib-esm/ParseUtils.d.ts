...
export declare class ParseUtils {
    ...
    static parseFloatingPointFormat(bytes: Uint8Array, ebits: number, fbits: number): number | null;
    ...
    static extractPixelValue(offset: number, bytes: Uint8Array, bitpix: number): number | null;
}
