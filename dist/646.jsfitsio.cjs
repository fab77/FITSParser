...
async function getFile(uri) {
    ...
    // }
    try {
        const response = await cross_fetch__WEBPACK_IMPORTED_MODULE_0___default()(uri);
        if (response?.ok) {
            buffer = await response.arrayBuffer();
        }
        else {
...
/* harmony export */ });
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(203);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(611);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16);
/* harmony import */ var whatwg_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(417);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(692);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(106);
...
;
//# sourceMappingURL=646.jsfitsio.cjs.map